...
function NetworkClass:Construct(Class)
    function Class.Extended(Class, ClassName)
        ...
        Class.Infinity.Network[#Class.Infinity.Network + 1] = Class
        ...
        Class.Function:Bind(function(Client, ClientPacket)
			...
			elseif ClientPacket[1] == 1 then -- call function
                return (ClientPacket[2] and Class.Client[ClientPacket[3]](Class, table.unpack(ClientPacket[4]))) or Class.Client[ClientPacket[3]](table.unpack(ClientPacket[4]))
            else
